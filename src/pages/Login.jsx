        ...
        <div className="relative w-full lg:w-2/3 h-64 lg:h-full group overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white bg-black/20 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              ...
              <p className="text-lg lg:text-xl text-blue-100">Continue your journey with us</p>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/3 bg-gradient-to-br from-blue-600/90 via-blue-700/90 to-blue-800/90 backdrop-blur-xl flex flex-col justify-center items-center text-white p-8 lg:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-sm">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 bg-white/10 border-white/20 rounded focus:ring-white/30 focus:ring-2"
                  />
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-blue-200 mb-2">Quick access for demo:</p>
              <div className="flex space-x-2">
                <button
                  type="button"
                  onClick={() => setFormData({email: "demo@example.com", password: "demo123"})}
                  className="flex-1 text-xs py-1 px-2 bg-white/10 rounded text-blue-200 hover:bg-white/20 transition-colors"
                >
                  Demo User
                </button>
              </div>
